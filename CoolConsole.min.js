...
function cc_success(text,title,customTitle){let title_text="%c";if(!title&&!customTitle){title_text="%c"}
if(title&&!customTitle){title_text="%c[ Success ]"}
if(title&&customTitle){title_text="%c[ "+customTitle+" ]"}
if(isStringOrNumber(text)){console.log("%c       "+title_text+" \n%c"+text,`    background-image: url("data:image/svg+xml,%0A%3Csvg version='1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48' enable-background='new 0 0 48 48'%3E%3Ccircle fill='%234CAF50' cx='24' cy='24' r='21'/%3E%3Cpolygon fill='%23CCFF90' points='34.6,14.6 21,28.2 15.4,22.6 12.6,25.4 21,33.8 37.4,17.4'/%3E%3C/svg%3E%0A");
        background-repeat: no-repeat;background-size: contain ; 
...
function cc_info(text,title,customTitle){let title_text="%c";if(!title&&!customTitle){title_text="%c"}
if(title&&!customTitle){title_text="%c[ Info ]"}
if(title&&customTitle){title_text="%c[ "+customTitle+" ]"}
if(isStringOrNumber(text)){console.log("%c       "+title_text+" \n%c"+text,`    background-image: url("data:image/svg+xml,%0A%3Csvg version='1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48' enable-background='new 0 0 48 48'%3E%3Ccircle fill='%232196F3' cx='24' cy='24' r='21'/%3E%3Crect x='22' y='22' fill='%23fff' width='4' height='11'/%3E%3Ccircle fill='%23fff' cx='24' cy='16.5' r='2.5'/%3E%3C/svg%3E%0A");
        background-repeat: no-repeat;background-size: contain ; 
...
function cc_danger(text,title,customTitle){let title_text="%c";if(!title&&!customTitle){title_text="%c"}
if(title&&!customTitle){title_text="%c[ Danger ]"}
if(title&&customTitle){title_text="%c[ "+customTitle+" ]"}
...
function cc_error(text,title,customTitle){let title_text="%c";if(!title&&!customTitle){title_text="%c"}
if(title&&!customTitle){title_text="%c[ Error ]"}
if(title&&customTitle){title_text="%c["+customTitle+"]"}
if(isStringOrNumber(text)){console.log("%c       "+title_text+" \n%c"+text,`    background-image: url("data:image/svg+xml,%3Csvg width='50px' height='50px' viewBox='-5 -5 58 58' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' xmlns:sketch='http://www.bohemiancoding.com/sketch/ns'%3E%3C!-- Generator: Sketch 3.2.2 %289983%29 - http://www.bohemiancoding.com/sketch --%3E%3Ctitle%3E228 - Error %28Flat%29%3C/title%3E%3Cdesc%3ECreated with Sketch.%3C/desc%3E%3Cdefs%3E%3C/defs%3E%3Cg id='Page-1' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd' sketch:type='MSPage'%3E%3Cg id='228---Error-%28Flat%29' sketch:type='MSLayerGroup'%3E%3Cpath d='M50,25 C50,38.807 38.807,50 25,50 C11.193,50 0,38.807 0,25 C0,11.193 11.193,0 25,0 C38.807,0 50,11.193 50,25' id='Fill-716' fill='%23D75A4A' sketch:type='MSShapeGroup'%3E%3C/path%3E%3Cpath d='M16,34 L34,16' id='Path' stroke='%23FFFFFF' stroke-width='2' stroke-linecap='round' sketch:type='MSShapeGroup'%3E%3C/path%3E%3Cpath d='M16,16 L34,34' id='Path' stroke='%23FFFFFF' stroke-width='2' stroke-linecap='round' sketch:type='MSShapeGroup'%3E%3C/path%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
        background-repeat: no-repeat;background-size: contain ; 
         font-size: 13px; padding: 5px ; color: `+COLOR_CONSOLE_DANGER+`;
...
function check_icon(logo){if(logo!=icon_flower&&logo!=icon_ok&&logo!=icon_heart&&logo!=icon_user_f&&logo!=icon_user_m&&logo!=icon_message&&logo!=icon_facebook&&logo!=icon_youtube&&logo!=icon_github&&logo!=icon_add&&logo!=icon_remove&&logo!=icon_time&&logo!=icon_music&&logo!=icon_setting&&logo!=icon_cursor&&logo!=icon_star&&logo!=icon_greenflag&&logo!=icon_redflag&&logo!=icon_yellowflag&&logo!=icon_blueflag&&logo!=icon_key&&logo!=icon_love&&logo!=icon_map&&logo!=icon_thumb_up&&logo!=icon_thumb_down&&logo!=icon_zoomin&&logo!=icon_zoomout&&logo!=icon_wifi&&logo!=icon_world&&logo!=icon_send&&logo!=icon_hand&&logo!=icon_picture&&logo!=icon_phone&&logo!=icon_folder&&logo!=icon_audio&&logo!=icon_diamond&&logo!=icon_money&&logo!=icon_idea&&logo!=icon_computer)
return!1;else{return!0}}
function cc_icon(logo,text,customTitle){if(!text){console.error("Text is empty! Please check your text");return}
if(check_icon(logo)){let title_text="%c";if(!customTitle){title_text="%c"}
if(customTitle){title_text="%c[ "+customTitle+" ]"}
if(isStringOrNumber(text)){console.log("%c     "+title_text+"\n%c "+text,`    `+logo+`
            background-repeat: no-repeat;background-size: contain ; 
             font-size: 13px; padding: 5px ; color: `+COLOR_CONSOLE_DEFAULT+`;
            `,bold,`color: `+COLOR_CONSOLE_DEFAULT+`;`+DEFAULT_STYLE)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
else{console.error("Incorrect Icon! Please Read Documentation")}}
function cc_color(text,color){if(isStringOrNumber(text)){console.log("%c"+text,`color: `+color+`;`+DEFAULT_STYLE)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_zebre(){if(isStringOrNumber(arguments[0])){let color1=DEFAULT_STYLE+" color: grey";let color2=DEFAULT_STYLE+" color : black";let text=arguments[0].toString();let args=new Array();let newtext='';let text_length=text.length;for(let index=0;index<text_length;index++){newtext+="%c"+text.charAt(index)}
args.push(newtext);for(let index=0;index<text_length;index++){if(index%2==0)
args.push(color1);else{args.push(color2)}}
return console.log.apply(this,args)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(arguments[0])}}
function cc_rainbow(text){if(isStringOrNumber(arguments[0])){let args=Array();let color1=DEFAULT_STYLE+" color: red";let color2=DEFAULT_STYLE+" color: orange";let color3=DEFAULT_STYLE+" color: yellow";let color4=DEFAULT_STYLE+" color: green";let color5=DEFAULT_STYLE+" color: blue";let color6=DEFAULT_STYLE+" color: indigo";let color7=DEFAULT_STYLE+" color: violet";let colors=[color1,color2,color3,color4,color5,color6,color7];text=text.toString();let newtext='';let text_length=text.length;for(let index=0;index<text_length;index++){newtext+="%c"+text.charAt(index)}
args.push(newtext);let counter=0;for(let index=0;index<text_length;index++){if(counter<7){args.push(colors[counter]);counter++}
else{counter=0
args.push(colors[counter]);counter++}}
return console.log.apply(this,args)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_bold(text){if(isStringOrNumber(text)){console.log("%c"+text,DEFAULT_STYLE+bold)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_italic(text){if(isStringOrNumber(text)){console.log("%c"+text,DEFAULT_STYLE+italic)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_midline(text){if(isStringOrNumber(text)){console.log("%c"+text,DEFAULT_STYLE+midline)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_underline(text){if(isStringOrNumber(text)){console.log("%c"+text,DEFAULT_STYLE+underline)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_xsmall(text){if(isStringOrNumber(text)){console.log("%c"+text,DEFAULT_STYLE+xsmall)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_small(text){if(isStringOrNumber(text)){console.log("%c"+text,DEFAULT_STYLE+small)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_medium(text){if(isStringOrNumber(text)){console.log("%c"+text,DEFAULT_STYLE+medium)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_large(text){if(isStringOrNumber(text)){console.log("%c"+text,DEFAULT_STYLE+large)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_xlarge(text){if(isStringOrNumber(text)){console.log("%c"+text,DEFAULT_STYLE+xlarge)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(text)}}
function cc_all(){if(isStringOrNumber(arguments[0])){let text=arguments[0];let text_styles="";let args=Array();args.push(text);for(let index=1;index<arguments.length;index++){args.push(arguments[index])}
args.forEach(element=>{if(element==normal){text_styles+=normal}
...
if(element.toString().includes("%")||element.toString().includes("ch")||element.toString().includes("cm")||element.toString().includes("em")||element.toString().includes("ex")||element.toString().includes("in")||element.toString().includes("mm")||element.toString().includes("pc")||element.toString().includes("pt")||element.toString().includes("px")||element.toString().includes("rem")||element.toString().includes("vh")){text_styles+=" font-size: "+element+";"}});console.log("%c"+arguments[0],text_styles)}
else{console.warn("You Can't use PrettyConsole with Objects 😪 ! Please Read Documentation");console.log(arguments[0])}}
function isTextNotParam(text){if(text!=normal&&text!=bold&&text!=italic&&text!=underline&&text!=midline&&text!=xsmall&&text!=small&&text!=medium&&text!=large&&text!=xlarge&&text!=red&&text!=orange&&text!=yellow&&text!=blue&&text!=green&&text!=indigo&&text!=brown&&text!=black&&text!=grey&&text!=white&&text!=cyan&&text!=pink&&text!=magenta&&text!=gold&&text!=navy&&text!=bg_red&&text!=bg_orange&&text!=bg_yellow&&text!=bg_blue&&text!=bg_indigo&&text!=bg_brown&&text!=bg_black&&text!=bg_grey&&text!=bg_white&&text!=bg_cyan&&text!=bg_pink&&text!=bg_magenta&&text!=bg_gold&&text!=bg_green&&text!=bg_navy&&!(text.toString().includes("px"))&&!(text.toString().includes("#")))
return!0;else{return!1}}
function test_sizeparam(text){if((text.includes("px"))&&(!text.includes("font-size")))
return!0;else return!1}
function add_stylesizeparam(text){let text_size_css="";if(test_sizeparam(text)){text_size_css+=" font-size: "+text+";"}
return text_size_css}
function test_customcolor(text){if((text.includes("#")))
return!0;else return!1}
function add_StyleCustomColorParam(text){let style_color_css="";if(test_customcolor(text)){style_color_css+=" color: "+text+";"}
return style_color_css}
function cc(){let all_text_with_c="";let args=Array();let text_array=Array();let counter_args=0;let counter_text=0;let isObj=!1;for(let index=0;index<arguments.length;index++){if(typeof arguments[index]!="string"&&typeof arguments[index]!="number"){isObj=!0;console.warn("You Can't use CoolConsole with Objects 😪 ! Please Read Documentation");console.log(arguments[index])}
if(isTextNotParam(arguments[index])){all_text_with_c+="%c"+arguments[index];text_array.push(arguments[index]);counter_text++}
else{if(test_customcolor(arguments[index])){arguments[index]=add_StyleCustomColorParam(arguments[index])}
if(test_sizeparam(arguments[index])){arguments[index]=add_stylesizeparam(arguments[index])}
if(counter_args>=counter_text){args[args.length-1]=args[args.length-1]+arguments[index]}
else{args.push(arguments[index]);counter_args++}}}
args.unshift(all_text_with_c);if(isTextNotParam(arguments[arguments.length-1]))
{args.push(normal)}
if(!isObj){return console.log.apply(this,args)}}
function cc_line(color){if(!color){color="ED7161"}
let mycolor=color.replace("#","%23");console.log("%c\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n",`
            font-size: 12px;
